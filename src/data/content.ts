...
export type Video = {
  ...
  title: string;
  channel: string;
  species: "Dogs" | "Cats" | "Birds" | "Rabbits" | "Reptiles" | "Fish" | "Hamsters" | "Other";
  duration: string;
};

/** Real, publicly available YouTube guides embedded via youtube-nocookie.com. */
export const VIDEOS: Video[] = [
  ...
  {
    id: "t_Q7WMntlMo",
    title: "How to Take Care of a Parakeet — Beginner's Guide to Pet Birds",
