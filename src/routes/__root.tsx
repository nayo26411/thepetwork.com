  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">This corner is empty</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          The page you&apos;re looking for wandered off. Let&apos;s get you back home.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "The Petwork" },
      { property: "og:title", content: "The Petwork — A home for every pet and every owner" },
      {
        property: "og:description",
        content: "Everything a Delhi NCR pet owner needs, in one warm and trusted place.",
      },
...
function RootComponent() {
  ...
  const bare = pathname.startsWith("/founder") || pathname.startsWith("/pro-signup");
