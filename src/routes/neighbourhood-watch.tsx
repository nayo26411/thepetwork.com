...
const IMAGES: Record<string, string> = {
  ...
  "cafe-cyberhub-social":
    "https://images.unsplash.com/photo-1525610553991-2bede1a236e2?auto=format&fit=crop&w=1200&q=85",
  "cafe-dwarka":
    "https://images.unsplash.com/photo-1516684732162-798a0062be99?auto=format&fit=crop&w=1200&q=85",
  "piano-man-safdarjung":
  ...
  "vetic-gk":
    "https://images.unsplash.com/photo-1559715745-e1b33a271c8f?auto=format&fit=crop&w=1200&q=85",
  "petsy-noida":
    "https://images.unsplash.com/photo-1597600159211-d6c104f408d1?auto=format&fit=crop&w=1200&q=85",
  "cgs-dwarka":
    "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&w=1200&q=85",
  "vet-lajpat":
    "https://images.unsplash.com/photo-1591946614720-90a587da4a36?auto=format&fit=crop&w=1200&q=85",
  "sanjay-gandhi-animal-care-raja-garden":
    "https://images.unsplash.com/photo-1548767797-d8c844163c4a?auto=format&fit=crop&w=1200&q=85",
  "cgs-hospital-dlf-phase3":
    "https://images.unsplash.com/photo-1596492784531-6e6eb5ea9993?auto=format&fit=crop&w=1200&q=85",
  "dr-anands-pets-hospital-vikaspuri":
    "https://images.unsplash.com/photo-1603481546238-487240415921?auto=format&fit=crop&w=1200&q=85",
  "friendicoes-seca-jangpura":
    "https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&w=1200&q=85",
  "pfa-delhi-animal-hospital-harinagar":
    "https://images.unsplash.com/photo-1581888227599-779811939961?auto=format&fit=crop&w=1200&q=85",
  "shroffs-animal-wing-daryaganj":
    "https://images.unsplash.com/photo-1587300003388-59208cc962cb?auto=format&fit=crop&w=1200&q=85",
  "jeevashram-animal-hospital-gurgaon":
    "https://images.unsplash.com/photo-1573865526739-10659fec78a5?auto=format&fit=crop&w=1200&q=85",
  "mahendales-pet-clinic-noida-50":
    "https://images.unsplash.com/photo-1576201836106-db1758fd1c97?auto=format&fit=crop&w=1200&q=85",
  "animal-care-centre-greater-noida":
    "https://images.unsplash.com/photo-1615233500064-138da78a0ece?auto=format&fit=crop&w=1200&q=85",
  "cessna-lifeline-vasant-kunj":
  ...
  "furrmaid-noida":
    "https://images.unsplash.com/photo-1535294435445-d7249524ef2e?auto=format&fit=crop&w=1200&q=85",
  "pawfect-gurgaon":
    "https://images.unsplash.com/photo-1587764379873-97837921fd44?auto=format&fit=crop&w=1200&q=85",
  "groom-dwarka":
    "https://images.unsplash.com/photo-1560807707-8cc77767d783?auto=format&fit=crop&w=1200&q=85",
  "fur-ball-story-hauzkhas":
    "https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?auto=format&fit=crop&w=1200&q=85",
  "petstudio-noida-50":
    "https://images.unsplash.com/photo-1591160690555-5d7e4a2669b8?auto=format&fit=crop&w=1200&q=85",
  "groom-room-gurugram":
    "https://images.unsplash.com/photo-1548767797-d8c844163c4a?auto=format&fit=crop&w=1200&q=85",
  "snip-wag-vk":
    "https://images.unsplash.com/photo-1494947665470-20322015e3a8?auto=format&fit=crop&w=1200&q=85",
  "pawfect-grooming-dwarka":
    "https://images.unsplash.com/photo-1522276498395-f4f68f7f8454?auto=format&fit=crop&w=1200&q=85",

  "heads-up-vk":
    "https://images.unsplash.com/photo-1607923432780-7a9c30adcb73?auto=format&fit=crop&w=1200&q=85",
  "hut-cp":
    "https://images.unsplash.com/photo-1568640347023-a616a30bc3bd?auto=format&fit=crop&w=1200&q=85",
  "store-lajpat":
  ...
  "hupt-dlf-promenade":
    "https://images.unsplash.com/photo-1589924691995-400dc9ecc119?auto=format&fit=crop&w=1200&q=85",
  "wiggles-lajpat":
    "https://images.unsplash.com/photo-1603189343302-e603f7add05a?auto=format&fit=crop&w=1200&q=85",
  "petsutra-janakpuri":
    "https://images.unsplash.com/photo-1601758228041-f3b2795255f1?auto=format&fit=crop&w=1200&q=85",
  "pet-shop-cp":
    "https://images.unsplash.com/photo-1583337130417-3346a1be7dee?auto=format&fit=crop&w=1200&q=85",
  ...
  "park-dda-vk":
    "https://images.unsplash.com/photo-1519331379826-f10be5486c6f?auto=format&fit=crop&w=1200&q=85",
  "park-noida-sec-50":
    "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=1200&q=85",
  "park-leisure-valley":
    "https://images.unsplash.com/photo-1552083375-1447ce886485?auto=format&fit=crop&w=1200&q=85",
  "park-dwarka-sec-11":
  ...
  "sanjay-van":
    "https://images.unsplash.com/photo-1473081556163-2a17de81fc2a?auto=format&fit=crop&w=1200&q=85",
  "dda-park-dwarka-10":
    "https://images.unsplash.com/photo-1504208434309-cb69f4fe52b0?auto=format&fit=crop&w=1200&q=85",
  "central-park-cp":
    "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?auto=format&fit=crop&w=1200&q=85",
  "garden-of-five-senses":
    "https://images.unsplash.com/photo-1425082661705-1834bfd09dca?auto=format&fit=crop&w=1200&q=85",
